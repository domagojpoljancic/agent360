...
export const valueDeliveredData: Record<ValueTimeRange, ValueSnapshot> = {
  ...
  '7d': {
    ...
    insights: [
      ...
      { id: 'inventory-week', agent: 'Inventory & Fulfillment Agent', headline: 'Inventory Agent reduced stockout investigation time by 61%.', metric: '690h saved', narrative: 'Warehouse and order context now resolves exceptions faster.', impactLabel: 'Operational efficiency', sparkline: trendPatterns.inventoryRecovery },
  ...
  '30d': {
    ...
    insights: [
      ...
      { id: 'inventory-month', agent: 'Inventory & Fulfillment Agent', headline: 'Inventory Agent created €780k in measured operations value.', metric: '€780k value', narrative: 'Faster exception investigation is shortening internal cycle time.', impactLabel: 'Operational efficiency', sparkline: trendPatterns.inventoryRecovery },
    ],
    workflowStories: [
